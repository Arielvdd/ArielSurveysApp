...
import com.example.arielsurveysapp.databinding.ActivitySurveyDetailsBinding;
...
public class SurveyDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_survey_details);
